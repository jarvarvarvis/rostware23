...
impl PenguinBitset {
    ...
    fn add_penguin_at_coordinate(&mut self, coordinate: Coordinate) {
        ...
        self.value = (self.value & !PENGUIN_COUNT_BIT_MASK)
            | ((team_penguin_count + 1) & PENGUIN_COUNT_BIT_MASK);
...
mod tests {
    ...
    fn get_coords_at_bitset_index() {
        let test_bitset = PenguinBitset { value: 0b001001001 };
    ...
    fn add_penguin_at_pos_of_bitset() {
        let mut test_bitset = PenguinBitset { value: 0b010010010 };
    ...
    fn add_penguin_at_position_0_0_and_try_get_it_back() {
        ...
        penguin_bitset.add_penguin(Penguin {
        ...
        let penguin_at_wrong_coordinate =
            penguin_bitset.get_penguin(Coordinate::new(1, 1), Team::One);
    ...
    fn moving_penguins_doesnt_increase_penguin_count() {
        ...
        penguin_bitset
            .move_penguin(penguin, Coordinate::new(6, 4))
            .unwrap();
        assert_eq!(1, penguin_bitset.get_penguin_count());
    }
    ...
    fn moved_penguin_doesnt_exist_at_previous_coordinate() {
        ...
        penguin_bitset.add_penguin(penguin.clone());
        penguin_bitset
            .move_penguin(penguin, Coordinate::new(5, 3))
            .unwrap();
